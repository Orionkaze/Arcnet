    ...
    <div className="flex gap-2 justify-between w-full" onPaste={handlePaste}>
      {digits.map((digit, index) => (
        <input
          ...
          className="w-[48px] h-[56px] bg-[#080c14] border border-[rgba(0,180,230,0.18)] focus:border-[#00b4e6] rounded-[8px] text-center text-white font-chakra font-bold text-[24px] outline-none transition-colors duration-200 flex-1 md:flex-none"
        />
      ))}
    </div>
  );
