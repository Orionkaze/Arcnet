    ...
    >
      <div className="flex flex-col w-full">
        ...
        {activeTab === "options" && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <button
              ...
              className="flex flex-col items-center justify-center p-6 bg-[#0d1320] border border-[rgba(0,180,230,0.18)] rounded-[10px] hover:border-[#00b4e6] transition-colors group"
            >
              <div className="w-12 h-12 rounded-full bg-[rgba(0,180,230,0.1)] flex items-center justify-center text-[#00b4e6] mb-3 group-hover:scale-110 transition-transform">
            ...
            <div className="grid grid-cols-4 gap-4">
              {presetAvatars.map((url, i) => (
                <button
                  ...
                  className="aspect-square bg-[rgba(0,180,230,0.05)] border border-[rgba(0,180,230,0.15)] rounded-full hover:border-[#00b4e6] overflow-hidden transition-all"
                >
        ...
        {activeTab === "camera" && (
          <div className="mb-8 flex flex-col items-center">
            ...
            <button
              ...
              className="w-12 h-12 bg-white rounded-full border-4 border-[rgba(0,180,230,0.3)] hover:scale-105 transition-transform"
            />
        ...
        {activeTab === "preview" && selectedAvatar && (
          <div className="mb-8 flex flex-col items-center">
            <div className="w-32 h-32 rounded-full overflow-hidden border-2 border-[#00b4e6] shadow-[0_0_24px_rgba(0,180,230,0.3)] mb-4">
              {/* eslint-disable-next-line @next/next/no-img-element */}
